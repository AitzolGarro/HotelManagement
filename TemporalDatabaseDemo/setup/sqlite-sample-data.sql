-- SQLite Temporal Demo - Sample Data
-- Insert sample data into SQLite temporal tables

-- =====================================================
-- 1. INSERT EMPLOYEES DATA
-- =====================================================

INSERT INTO Employees (FirstName, LastName, Email, Department, Position, Salary, HireDate, IsActive)
VALUES 
...
SELECT 'Employees data inserted: ' || COUNT(*) || ' records' FROM Employees;

-- =====================================================
-- 2. INSERT PRODUCTS DATA
-- =====================================================

INSERT INTO Products (ProductName, Category, Price, Cost, StockQuantity, Description, IsActive)
VALUES 
...
SELECT 'Products data inserted: ' || COUNT(*) || ' records' FROM Products;

-- =====================================================
-- 3. INSERT CUSTOMERS DATA
-- =====================================================

INSERT INTO Customers (FirstName, LastName, Email, Phone, Address, City, State, ZipCode, CustomerTier, IsActive)
VALUES 
...
SELECT 'Customers data inserted: ' || COUNT(*) || ' records' FROM Customers;

-- =====================================================
-- 4. INSERT SYSTEM CONFIGURATION DATA
-- =====================================================

INSERT INTO SystemConfig (ConfigKey, ConfigValue, Description, Category, IsActive)
VALUES 
...
SELECT 'System config data inserted: ' || COUNT(*) || ' records' FROM SystemConfig;

-- =====================================================
-- VERIFY DATA INSERTION
-- =====================================================

SELECT 'Data insertion summary:';
...
SELECT 'Sample data insertion completed at: ' || CURRENT_TIMESTAMP;