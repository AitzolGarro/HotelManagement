...
{
    /// <inheritdoc />
    public partial class AddDashboardCustomization : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WidgetConfigurationsJson = table.Column<string>(type: "TEXT", nullable: false, defaultValue: "[]"),
        ...
        {
            migrationBuilder.DropTable(name: "UserDashboardPreferences");
        }
    }
}
